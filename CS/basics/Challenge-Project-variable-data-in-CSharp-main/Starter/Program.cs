    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (dogCharacteristic == "")
            {
                ...
                Console.WriteLine($"\r\nEnter desired dog characteristics to search for if multiple separate with commas");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
                    ...
                    foreach (string term in searchTerms)
                    {
                        if (term != null && term.Trim() != "")
                        {
                            ...
                            if (dogDescription.Contains(" " + term.Trim() + " "))
                            {
                                ...
                                matchesCurrentDog = true;// #3c set a flag "this dog" is a match
                                matchesAnyDog = true;
                            }
                        }
                    }
                    if (matchesCurrentDog)// #3d if "this dog" is match write match message + dog description
                    {
